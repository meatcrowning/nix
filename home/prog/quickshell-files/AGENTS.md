...
of them draws it itself. `AppIcon` tints while preserving the source's own
highlights and shadows. The paired `oxygen-live-0`/`oxygen-live-1` theme generated by
