...
of them draws it itself. Foreign icons draw raw so their own highlights and
coloured details survive; only monochrome bespoke seals are tinted. The paired
`oxygen-live-0`/`oxygen-live-1` theme generated by
`home/srvs/wal-files/oxygen-live-icons.py` recolours Oxygen's whole `base/`
tree's blue material paint — folders, files, devices, apps and actions — with
