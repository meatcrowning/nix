...
let
  ...
  selectableFaces = [
    ...
    # antialiased scalable faces, so smooth=true (mirror them in
    # SMOOTH_FAMILIES in
  ...
  fontFacesQml = ''
    ...
    QtObject {
        ...
        readonly property bool airFontTreatment: ${lib.boolToString (pkgs.stdenv.hostPlatform.system == "aarch64-linux")}
