...
# Location.qml is generated by home/prog/quickshell.nix from private Nix
# defaults and is absent from the public source fixture. Keep this probe
# deterministic with a neutral city-level value.
cat > "$P/home/.config/quickshell/Location.qml" <<'EOF'
pragma Singleton
import QtQuick
QtObject {
    readonly property real latitude: 0
    readonly property real longitude: 0
    readonly property string place: "test"
}
EOF
