...
# defaults and therefore is absent from the public source fixture. Keep this
# UI test deterministic with a neutral city-level value.
cat >"$WORK/Location.qml" <<'QML'
pragma Singleton
import QtQuick
QtObject {
