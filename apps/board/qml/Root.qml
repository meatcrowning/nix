...
Item {
    ...
    readonly property var tbButtons: [
        { id: "needs",  label: "ny", state: section === "needs" ? 1 : 0,
          tip: "what needs you", menu: "go", icon: "go-up" },
        { id: "agents", label: "ag", state: section === "agents" ? 1 : 0,
          tip: "the triangle - who is running now", menu: "go", icon: "system-run" },
        { id: "landed", label: "ld", state: section === "landed" ? 1 : 0,
          tip: "what landed", menu: "go", icon: "document-save" },
        "-",
        { id: "reader", label: "md", state: 0, tip: "open board.md in reader",
          menu: "file", icon: "text-x-generic", bar: true },
    ...
    DeskMenuBar {
        ...
        // Plasma's QMainWindow renders the authoritative native menubar from
        // this same action table.  Keeping this shell face inactive prevents
        // a second, hand-drawn menu directly beneath it.
        systemBar: true
