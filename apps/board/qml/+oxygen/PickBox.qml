...
Item {
    ...
    // A real button makes the compact chooser read as part of Oxygen while its
    // existing menu model preserves the board's honest, live-state labels.
