...
// wallpaper change — so editor recolours live, in lock-step with the bar. The SYNTAX
// colours are the same palette, resolved on the Python side (highlight.py's
// ROLE table) because a QSyntaxHighlighter cannot bind to QML.
QtObject {
    ...
    // window is unfocused (plugin inactiveColor 0xaa595959). Used across editor
