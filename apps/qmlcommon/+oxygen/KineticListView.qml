...
// The list scroller, in a Plasma session wearing OXYGEN.
//
...
ListView {
    ...
    // sibling's constraint, unchanged and for its own reason: a view's default property moves declared child Items into its contentItem
