...
has("show me a satellite image of Lisbon", "satellite_observe")
has("check Copernicus Sentinel-2 over Iceland", "satellite_observe")
has("are there active fires near Palermo?", "satellite_observe")
